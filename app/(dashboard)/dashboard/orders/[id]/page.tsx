      ...
      <div className="flex-1 overflow-y-auto pt-6 pb-12 scrollbar-hide">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 max-w-7xl mx-auto">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <Card className="bg-zinc-950 border border-zinc-800 overflow-hidden pt-0">
                ...
                <div className="p-4 bg-primary/5 border-t border-primary/20 flex flex-col sm:flex-row items-center gap-3">
                  <div className="flex-1 w-full flex items-center gap-2">
                    ...
                    <Input
                      ...
                      className="bg-zinc-900 border-zinc-800 h-9 text-sm w-full text-white placeholder:text-zinc-500 focus:border-primary focus:ring-1 focus:ring-primary"
                      autoFocus
                    />
                  </div>
                  ...
                  <Button
                    size="sm"
                    className="w-full sm:w-auto h-9 font-bold bg-primary hover:bg-primary/90 text-white shrink-0"
                  >
                    Mark as Shipped
                  </Button>
                </div>
            ...
            <Card className="bg-zinc-950 border border-zinc-800">
              ...
              <CardContent className="space-y-2 text-sm">
                ...
                <div className="flex justify-between text-zinc-400">
                  <span>Shipping (Standard)</span><span>$0.00</span>
                </div>

                <div className="flex justify-between text-zinc-400">
                  <span>Tax</span><span>$10.20</span>
                </div>

                <div className="flex justify-between font-bold text-white pt-2 border-t border-zinc-800 mt-2">
                  <span>Total</span><span>$130.20</span>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="lg:col-span-5 grid grid-rows-2 gap-6">
            ...
            <Card className="bg-zinc-950 border border-zinc-800 pt-0 overflow-y-hidden">
              <CardHeader className="py-4 border-b border-zinc-800 bg-zinc-900">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-zinc-500 mt-0.5">
                      1 order • Customer since Oct 2025
                    </p>
                  </div>
                </div>
              </CardHeader>
              ...
              <CardContent className="p-4 space-y-4">
                ...
                {/* Fraud Alert */}
                <div className="bg-red-500/10 border border-red-500/30 p-3 rounded-lg flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-red-400/80 mt-1">
                      Billing ZIP code does not match credit card registered address.
            ...
            <Card className="bg-zinc-950 border border-zinc-800">
              ...
              <CardContent className="p-6 pt-0">
                <div className="relative border-l-2 border-zinc-800 ml-3 space-y-6">
                  ...
                  <div className="relative pl-6">
                    <span className="absolute -left-[9px] top-1 h-4 w-4 rounded-full bg-zinc-950 border-2 border-emerald-500 flex items-center justify-center">
